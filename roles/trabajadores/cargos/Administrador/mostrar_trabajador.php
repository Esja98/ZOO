...
<table>
    <tbody>
        <tr>
            <th class="stilo2"><?php echo "<a href='modificar_trabajador.php?id_t=$row[id_t]'>modificar</a> - <a href='acciones/eliminar_trabajador.php?id_t=$row[id_t]' >eliminar</a> <br/><br/>"; ?></th>
        </tr>
    </tbody>
</table>
<br/>
