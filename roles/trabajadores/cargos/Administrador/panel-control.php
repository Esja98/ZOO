      ...
      <div class="contenedorusuario">
          ...
          <div class="usuariobotones">
             ...
             <center><h2>¿Que desea hacer?</h2></center>
              ...
              <center>
                <a href="crear_trabajador.php"><div class="boton" >Añadir Trabajador</div></a>
                <br/>
                <a href="mostrar_trabajador.php"><div class="boton" >Mostrar Trabajador</div></a>
                <br/>
                <a href="agregar_zg.php"><div class="boton" >Añadir Zona Geografica</div></a>
                <br/>
                <a href="agregar_zn.php"><div class="boton" >Añadir Zona Natural</div></a>
                <br/>
                <a href="mostrar_zonag.php"><div class="boton" >Mostrar Zona Geografica</div></a>
                <br/>
                <a href="mostrar_zonan.php"><div class="boton" >Mostrar Zona Natural</div></a>
                <br/>
                <?php
