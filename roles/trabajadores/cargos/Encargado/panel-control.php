      ...
      <div class="contenedorusuario">
          ...
          <div class="usuariobotones">
             ...
             <center><h2>¿Que desea hacer?</h2></center>
              ...
              <center>
                <a href="ingresar_animal.php"><div class="boton" >Ingresar Animal</div></a>
                <br/>
                <a href="mostrar_animal.php"><div class="boton" >Mostrar Animales</div></a>
                <br/>
                <a href="solicitar_citas.php"><div class="boton" >Solicitar Cita</div></a>
                <br/>
                <?php
