...
$qy3="select * from zona_g";
$rs3=$conexion->query($qy3);
		...
		<main>
			...
			<form action="acciones/calcula_precio.php" method="GET">
						...
						<br/><br/>
							...
							<input class="form-control" name="zonas" type="text" placeholder="paquete" value="3">
						...
						<br/><br/>
							...
							<div class="letraformulario"><label  for="zona3">Zona 3:</label></div>
							<select class="form-control" name="zona3" id="option">
							<?php while($rw3=$rs3->fetch_assoc()){	?>
							<option value="<?php echo $rw3['nombre_zg']; ?>"><?php echo $rw3['nombre_zg']; ?></option>
							<?php }	?>
 							</select>

						<br/><br/>

							<div class="letraformulario"><label  for="adicional">Zonas Adicionales:</label></div>
							<input class="form-control" name="adicional" type="text" placeholder="Cantidad">
